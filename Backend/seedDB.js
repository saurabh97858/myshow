...
const seedDatabase = async () => {
    try {
        ...
        const theaterNames = ["PVR Cinemas", "INOX", "Cinepolis", "Carnival Cinemas", "Miraj Cinemas", "Mukta A2", "MovieTime", "Rajhans Cinemas", "NY Cinemas", "Wave Cinemas"];
        const theaterSuffixes = ["Mall", "Plaza", "Square", "City Center", "High Street", "Galleria", "Prime", "Nexus", "Grand", "Icon"];
        const theaterImages = [
